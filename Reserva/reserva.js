document.addEventListener("DOMContentLoaded", () => {
    ...
    if (emailInput && userEmail) {
        ...
        alert("No se encontró el email del usuario. Por favor, inicie sesión para reservar.");
        window.location.href = "http://127.0.0.1:8000/auth/login.html"; // Redirige a la página de login
    }
});
...
async function generarPDF() {
    ...
    const email = document.getElementById("email").value.trim(); // Este valor ya estará precargado
